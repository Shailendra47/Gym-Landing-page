...
export class RegistrationListComponent implements OnInit{
  ...
  displayedColumns: string[] = ['id', 'firstName', 'lastName', 'email', 'contact', 'bmiResult', 'gender', 'package', 'enquiryDate', 'action'] 
  ...
  delete(id: number) {
    this.confirm.showConfirm("Are you sure to delete user data?", 
    () => {
      this.api.deleteRegisterd(id).subscribe(res => {
